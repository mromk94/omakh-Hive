...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    chat: { placeholder: 'Ask me anything about OMK Hive...', send: 'Send', typeMessage: 'Type your message here', connecting: 'Connecting...', greeting: 'Welcome! I am Queen AI, your guide to OMK Hive. How can I help you today?', selectTheme: 'First, would you like light or dark theme?', selectThemeMessage: 'Select your preferred theme:' },
  ...
  es: {
    ...
    chat: { placeholder: 'Pregúntame cualquier cosa sobre OMK Hive...', send: 'Enviar', typeMessage: 'Escribe tu mensaje aquí', connecting: 'Conectando...', greeting: '¡Bienvenido! Soy Queen AI, tu guía para OMK Hive. ¿Cómo puedo ayudarte hoy?', selectTheme: 'Primero, ¿prefieres tema claro u oscuro?', selectThemeMessage: 'Selecciona tu tema preferido:' },
  ...
  zh: {
    ...
    chat: { placeholder: '询问关于 OMK Hive 的任何问题...', send: '发送', typeMessage: '在这里输入您的消息', connecting: '连接中...', greeting: '欢迎！我是 Queen AI，您的 OMK Hive 向导。今天我能帮您什么？', selectTheme: '首先，您想要明亮还是暗色主题？', selectThemeMessage: '选择您喜欢的主题：' },
  ...
  ja: {
    ...
    chat: { placeholder: 'OMK Hiveについて何でも聞いてください...', send: '送信', typeMessage: 'ここにメッセージを入力', connecting: '接続中...', greeting: 'ようこそ！私は Queen AI、OMK Hive のガイドです。今日はどのようにお手伝いできますか？', selectTheme: 'まず、ライトテーマとダークテーマのどちらがお好みですか？', selectThemeMessage: 'お好みのテーマを選択してください：' },
  ...
  pcm: {
    ...
    chat: { placeholder: 'Ask me anytin about OMK Hive...', send: 'Send', typeMessage: 'Type your message for here', connecting: 'Connecting...', greeting: 'Welcome! I be Queen AI, your guide for OMK Hive. Wetin I fit do for you today?', selectTheme: 'First, you wan light or dark theme?', selectThemeMessage: 'Pick your theme wey you like:' },
    wallet: { connect: 'Connect Wallet', disconnect: 'Disconnect', connected: 'Connected', balance: 'Balance', address: 'Address' },
  ...
  fr: {
    ...
    chat: { placeholder: 'Posez-moi des questions sur OMK Hive...', send: 'Envoyer', typeMessage: 'Tapez votre message ici', connecting: 'Connexion...', greeting: 'Bienvenue! Je suis Queen AI, votre guide pour OMK Hive. Comment puis-je vous aider aujourd\'hui?', selectTheme: 'D\'abord, préférez-vous un thème clair ou sombre?', selectThemeMessage: 'Sélectionnez votre thème préféré:' },
  ...
  ru: {
    ...
    chat: { placeholder: 'Спросите меня о OMK Hive...', send: 'Отправить', typeMessage: 'Введите сообщение здесь', connecting: 'Подключение...', greeting: 'Добро пожаловать! Я Queen AI, ваш гид по OMK Hive. Как я могу помочь вам сегодня?', selectTheme: 'Сначала, вы предпочитаете светлую или темную тему?', selectThemeMessage: 'Выберите предпочитаемую тему:' },
  ...
  ar: {
    ...
    chat: { placeholder: 'اسألني أي شيء عن OMK Hive...', send: 'إرسال', typeMessage: 'اكتب رسالتك هنا', connecting: 'جاري الاتصال...', greeting: 'مرحباً! أنا Queen AI، مرشدك إلى OMK Hive. كيف يمكنني مساعدتك اليوم؟', selectTheme: 'أولاً، هل تفضل المظهر الفاتح أو الداكن؟', selectThemeMessage: 'اختر المظهر المفضل لديك:' },
